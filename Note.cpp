...
void NoteInit(void) {
	...
	Note[920 - 45 + Control.nMagic] = nKeyAL;  // 아 
	Note[922 - 45 + Control.nMagic] = nKeySK;  // 름    
	Note[924 - 45 + Control.nMagic] = nKeyDJ;  // 다
	Note[926 - 45 + Control.nMagic] = nKeySK;  // 운

	Note[934 - 43 + Control.nMagic] = nKeyDJ;  // 갤
	Note[940 - 43 + Control.nMagic] = nKeyDJ;  // 럭
	Note[946 - 43 + Control.nMagic] = nKeyDJ;  // 시

	Note[961 - 45 + Control.nMagic] = nKeyKL;  // be
	Note[963 - 45 + Control.nMagic] = nKeyAS;  // A
	Note[973 - 45 + Control.nMagic] = nKeyJ;   // writer
	Note[975 - 45 + Control.nMagic] = nKeyD;

	Note[990 - 45 + Control.nMagic] = nKeyDJ;  // 장
	Note[992 - 45 + Control.nMagic] = nKeySK;  // 르
	Note[994 - 45 + Control.nMagic] = nKeyAL;  // 로
	Note[996 - 45 + Control.nMagic] = nKeySK;  // 는

	Note[1008 - 45 + Control.nMagic] = nKeyDJ; // 판
	Note[1014 - 45 + Control.nMagic] = nKeySK; // 타
	Note[1020 - 45 + Control.nMagic] = nKeyAL; // 지

	Note[1029 - 45 + Control.nMagic] = nKeySD; // 내
	Note[1031 - 45 + Control.nMagic] = nKeyJK; // 일

	Note[1045 - 45 + Control.nMagic] = nKeyA;  // 내
	Note[1047 - 45 + Control.nMagic] = nKeyK;  // 게

	Note[1062 - 50 + Control.nMagic] = nKeySK; // 열
	Note[1064 - 50 + Control.nMagic] = nKeyDJ; // 리
	Note[1066 - 50 + Control.nMagic] = nKeyAL; // 는
	Note[1068 - 50 + Control.nMagic] = nKeySK; // 건

	Note[1078 - 48 + Control.nMagic] = nKeyD;  // big
	Note[1079 - 48 + Control.nMagic] = nKeyS;
	Note[1084 - 48 + Control.nMagic] = nKeyJ;  // big
	Note[1085 - 48 + Control.nMagic] = nKeyK;
	Note[1090 - 48 + Control.nMagic] = nKeyAL; // 스테이지

	Note[1116 - 50 + Control.nMagic] = nKeySJ; // so that
	Note[1122 - 50 + Control.nMagic] = nKeyK;  // is
	Note[1128 - 50 + Control.nMagic] = nKeyDK; // who
	Note[1136 - 50 + Control.nMagic] = nKeyDL; // I
	Note[1144 - 50 + Control.nMagic] = nKeyDJ; // am
}
// 기본 기능 함수
void Update() {
